 ...
 * @return 	없음
 * @example ufnCreateChart(objChart)
 */
pForm.ufnCreateChart = function(objChart)
{
	var svc_url = this.ufnGetServerUrl();
	...
	this.rMateChartCreate(objChart, scriptRootUrl, htmlUrl, this.ufnMakeChartVars());
};

/**
 * ufn_CreateChart 함수의 내부함수
 * @param 	없음
 * @return 	없음
 * @example ufnMakeChartVars()
 */
pForm.ufnMakeChartVars = function() {
	var chartVars = "";
 ...
 * @return 	없음
 * @example ufnSetChart(objChart, objDs, sLayoutType, arrOption)
 */
pForm.ufnSetChart = function(objChart, objDs, sLayoutType, arrOption)
{
	var sLayout = "";
 ...
 * @example ufnSetChart(objChart, objDs, sLayoutType, arrOption)
 */
pForm.ufnSetMultiChart = function(objChart, objDs, sLayoutType, arrOption)
{
	var sLayout = "";
	if (sLayoutType == "Line")
	{
 ...
 * @example ufnSetChart(objChart, objDs, sLayoutType, arrOption)
 */
pForm.ufnSetCombinationChart = function(objChart, objDs, arrOption)
{
	var sLayout = "";
	var arrYfield = arrOption.yfield.split(",");
	var arrDisplayName = arrOption.displayName.split(",");
